$(function () {
    ...
    $(".addUsers, .raport, .settings, .classAdd, .examAdd, .teacherAdd").hide();
    ...
    $("#classAddHeader").click(function () {
        $(".classAdd").toggle();
    });
    $("#examAddHeader").click(function () {
        $(".examAdd").toggle();
    });
    $("#teacherAddHeader").click(function () {
        $(".teacherAdd").toggle();
    });
    $(".iconpick").click(function(e){
        let i=$(e.target).parent().attr('data-iconpick');
        $(".iconpicked").html('<i class="fas fa-fw '+i+'"></i>');
    });
